...
export default function PrivacyPolicyPage({ searchParams }: PageProps) {
  const requestedVersion = searchParams.version;

  // 모든 버전 목록 가져오기
  const allVersions = getAllVersions('privacy');
  ...
  const filePath = getVersionFilePath('privacy', version);
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-6 pt-12 pb-6">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-center gap-6 text-sm text-muted-foreground">
            ...
            <VersionSelector versions={allVersions} currentPath="/legal/privacy-policy" />
          </div>
        </div>
