  ...
  return (
    <div className="min-h-screen bg-background pb-8">
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-6 pt-12 pb-6">
        {/* Header with Title */}
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-center">이용약관</h1>
          <div className="flex items-center justify-center gap-6 text-sm text-muted-foreground">
            ...
            <VersionSelector versions={allVersions} currentPath="/legal/terms-of-service" />
          </div>
        </div>
