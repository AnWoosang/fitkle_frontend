...
export default async function LocationTermsVersionPage({ params }: PageProps) {
  ...
  const targetFile = files.find(file => file.includes(`-${version}.md`) && file.includes('location-terms'));
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-6">
          <Link
            href="/legal/location-terms/archive"
